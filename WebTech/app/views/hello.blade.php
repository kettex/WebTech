        ...
        <div class="row">
            <div class="col-md-12">
                <div class="heading-section">
                    ...
                    <img src="../app/images/under-heading.png" alt="" >
                </div>
            </div>
        </div>
        <div class="row">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4 col-sm-6">
                <div class="blog-post">
                    <div class="blog-thumb">
                        <img src="../app/images/blogpost1.jpg" alt="" />
                    </div>
            ...
            <div class="col-md-4 col-sm-6">
                <div class="blog-post">
                    <div class="blog-thumb">
                        <img src="../app/images/blogpost2.jpg" alt="" />
                    </div>
                    <div class="blog-content">
                        <div class="content-show">
            ...
            <div class="col-md-4 col-sm-6">
                <div class="blog-post">
                    <div class="blog-thumb">
                        <img src="../app/images/blogpost3.jpg" alt="" />
                    </div>
                    <div class="blog-content">
                        <div class="content-show">
            ...
            <div class="col-md-4 col-sm-6">
                <div class="blog-post">
                    <div class="blog-thumb">
                        <img src="../app/images/blogpost4.jpg" alt="" />
                    </div>
                    <div class="blog-content">
                        <div class="content-show">
            ...
            <div class="col-md-4 col-sm-6">
                <div class="blog-post">
                    <div class="blog-thumb">
                        <img src="../app/images/blogpost5.jpg" alt="" />
                    </div>
                    <div class="blog-content">
                        <div class="content-show">
            ...
            <div class="col-md-4 col-sm-6">
                <div class="blog-post">
                    <div class="blog-thumb">
                        <img src="../app/images/blogpost6.jpg" alt="" />
                    </div>
                    <div class="blog-content">
                        <div class="content-show">
